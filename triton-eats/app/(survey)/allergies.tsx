...
export default function AllergiesScreen() {
  ...
  const handleNext = () => {
    ...
    router.push({
      pathname: "/(survey)/diet",
      params: { allergies: JSON.stringify(all) },
    });
  };
  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        <Text style={styles.heading}>Any food allergies?</Text>
        <Text style={styles.subheading}>Tap all that apply — skip if you're good</Text>
        ...
        <View style={styles.list}>
          ...
          <View style={styles.otherSection}>
            ...
            <TextInput
              ...
              placeholder="e.g. corn, mustard, celery"
